...
import { Flight,AirlineSeatReclineExtra,Groups, CalendarMonth,AirplanemodeActive , FlightTakeoff,AttachMoney, CenterFocusStrongOutlined} from "@mui/icons-material";
...
const Details = () => {
     ...
     return (
          ...
          <div>
          <strong className='mr-3'>: </strong><strong> MXRHIF </strong>
          </div>
          <div>
          <strong className='mr-3'>: </strong><strong> 540K9C </strong>
          </div>
          </div>
          </div>
          </div>
