...
import style from '../../../components/Tour/ToursSearch/ToursSearch.module.css'
                       ...
                       <div className={style.toursCardWrap}>
                        ...
                        <div className={style.toursCard}>
                            ...
                            <div className={style.toursCardRight}>
                                <h6 className="text-xl">Explore Dhaka City in a Local Way !!</h6>
                                ...
                                <div className={style.cardText}>
                                    ...
                                    <p>6–8 hours</p>
                                    <p>Stimulate your senses and challenge your photographic eye by taking part in the awakening of one of the world’s largest …Free cancellation</p>
                                ...
                                <div className={style.cardPrice}>
                                    <p>$989</p>
                                    <p>Per adults</p>
                                    <Link href='/busses/reserve'> <button>Reserve</button></Link>
                        ...
                        <div className={style.toursCard}>
                            ...
                            <div className={style.toursCardRight}>
                                ...
                                <div className={style.cardPrice}>
                                    <p>$989</p>
                                    <p>Per adults</p>
                                    <Link href='/tours/toursReserve'> <button>Reserve</button></Link>
