          ...
          <div >
              <div className="px-8 lg:px-0 text-gray-700 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto gap-8 group"> 
                              ...
                              <div className="bg-[#62C370] block rounded-lg shadow-lg h-full text-white" >
                                  ...
                                  <Image
                                  className="w-full rounded-t-lg h-72" alt='house'
                                  src={man} /> 
                                  ...
                                  <div className="p-6 h-60">
                                      <h5 className="text-lg font-bold mb-2">Ibrahim Sikder </h5>
                                    
                                      <div className="flex items-center justify-center space-x-2 text-[#fff]">
                                      ...
                                      <p className="pt-2">
                                          ...
                                          Travel is the movement of people between distant geographical locations. Travel can be done by foot, bicycle, automobile, train, boat, bus, airplane, ship etc.  
                                      </p>
                                  </div>
                              </div>
                                   </div>
