...
const TeamCard = () => {
  return (
    <section className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-300 shadow-lg dark:shadow-[#949494] transform duration-500 hover:-translate-y-2 cursor-pointer group">
