          ...
          <div>
            <div className={style.searchDetailHead}>
              <div>
                ...
                <h2 className="text-2xl font-bold">COX S BAZAR - BANGKOK(BANGKOK-ALL)</h2>
            ...
            <div className={style.hotelSearchBoxWrap}>
              <div className={style.hotelSearchLeftSide}>
                ...
                <Button variant="outlined"><ChevronLeftRounded/> </Button>
                ...
                <Button variant="outlined"><ChevronRightRounded/> </Button>
                </div>
                <div className="flex justify-between">
                    <div className={style.flight}>Earliest Flight</div>
                    <div className={style.flight}>Earliest Flight</div>
                    <div className={style.flight}>Earliest Flight</div>
                </div>
