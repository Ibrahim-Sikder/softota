  ...
  return (
    <div>
        ...
        <div className={styles.moveText}>
          ...
          onmouseover="this.stop();"  behavior="scroll" direction="left"> <h2 className="text-2xl font-bold">Ghuronti is your best partner for your journey.</h2></marquee>
        </div>
        </div>
        <div className={`${style.heroBoxMain} ${styles.heroBoxWrap}` }>
        
        <div>
        <ul className={`${style.menu} ${styles.menubar}`}>
        <li
        ...
        >
        <g opacity={0.4}>
        <path fill="#19ABE3" d="M0 .749h45V44.74H0z" />
        <path
        fill="#fff"
