...
const HajjBook = () => {
    ...
    return (
       ...
       <div className={styling.visaRquirementForUmrah}>
            <h2 className="text-2xl font-bold my-3">Required list of documents for Hajj visa processing from Dhaka Bangladesh</h2>
            <div className={styling.requirementText}>
                <Beenhere className={styling.checkIcon}/>
                <p className="ml-2">Original passport must be valid for six months from the date of travel and 4 blank pages for visa stamping</p>
            </div>
            <div className={styling.requirementText}>
                <Beenhere className={styling.checkIcon}/>
                <p className="ml-2">Most recent 2 copy passport size photographs with white background only </p>
            </div>
            <div className={styling.requirementText}>
                <Beenhere className={styling.checkIcon}/>
            ...
            <div className={styling.requirementText}>
                <Beenhere className={styling.checkIcon}/>
                <p className="ml-2">Health Requirements: Proof of OPV or IPV vaccination is required 6 weeks prior to the application for an entry visa</p>
            </div>
            <div className={styling.requirementText}>
                <Beenhere className={styling.checkIcon}/>
                <p className="ml-2">A woman traveling alone must be 45 years old and must obtain a letter of authorization (notarized) from her mahram</p>
            </div>
            <div className={styling.requirementText}>
                <Beenhere className={styling.checkIcon}/>
                <p className="ml-2">Copy of birth certificate for children (6 years)</p>
            </div>
        </div>
       ...
       <div className={style.visaRequestForm}>
        ...
        <div className={style.formControl}>
                <label  className={style.inputLabel}>Write down Your City <small className='text-red-500 text-xl'>*</small> </label>
