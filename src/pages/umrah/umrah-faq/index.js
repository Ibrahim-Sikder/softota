    ...
    <HajjLayout>
      <div className={style.visaRequirment}>
        ...
        <div className="my-5">
          ...
          <p>
            ওমরা প্যাকেজ হলো বাংলাদেশ থেকে কোন নাগরিক পবিত্র মক্কা ও মদিনা শহরে
            উমরার জন্য ভ্রমনে ইচ্ছুক হাজীদের জন্য সৌদি আরবের ওমরা ভিসা প্রসেসিং,
            আসা যাওয়া বিমান ভাড়া, হোটেল আবাসন ও যাতায়াত সহ নানাধরনের সুযোগ
            সুবিধা সংশ্লিষ্ট একটা সমন্বিত উদ্যোগ। যা নির্দিষ্ট সময়ের জন্য একজন
            বাংলাদেশি নাগরিকের মক্কা মদিনা যাত্রা সহজতরো করে।।
          </p>
          <div>
          ...
          <div className="mt-3">
            ...
            <p>
              ...
              সংম্পর্কে নির্দিষ্ট শর্তাবলী মেনে চলতে হবে। সময়ের জন্যে আবেদনের যে
              কে-কে সময় নির্ধারণ করে তা সরকারের নীতির অধীনে পরিপর্তন হতে পারে।
            </p>
          </div>
          <div className="mt-3">
            <strong>5. ওমরা ভিসার সময়কাল কতদিন?</strong>
            <p>
              সাধারনত ওমরা ভিসার মেয়াদকাল ৩০ দিন। তবে আপনাকে ওমরা ভিসা নিয়ে সৌদি
              আরবে প্রবেশের ২ সপ্তাহের মধ্যে অবশ্যই ওমরা করতে হবে।
            </p>
          </div>
          <div className="mt-3">
