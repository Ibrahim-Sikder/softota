       ...
       <div className={style.profileWrap}>
           ...
           <div className={style.userProfileRightSide}>
            <div className={style.saveCard}>
               ...
               <h4 className='text-2xl mt-5 font-bold '>You can delete your Ghuronti Account at any time. If <br />
                you change your mind, you might not be able to <br /> recover it.</h4>
                <div>
