            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 place-content-center place-items-center'>
                ...
                <div>
                    ...
                    <div className='mb-5'>
                          ...
                          <input onChange={(event)=>setName(event.target.value)} name='name' type='text' placeholder='User Name' className={style.loginInput}/>
                          </div>     
                          <div className='mb-5'>
                          ...
                          <input onChange={(event)=>setNumber(event.target.value)} name='number' type='number' placeholder='Number' className={style.loginInput}/>
                          </div>
                          <div className='mb-5'>
                          <label>Agent Number </label> <br/>
                          <input onChange={(event)=>setAnumber(event.target.value)} name='anumber' type='number' placeholder='Agent Number' className={style.loginInput}/>
                          </div>
