      ...
      <div className="mt-5 mb-24">
        <div className="flex items-center justify-between px-8 mb-5">
          ...
          <div className={style.addHotel}>
            <Link href='/b2bdashboard/manage/perform-umrah/add'>
            <button>
              <span className="text-xl font-bold">+</span> Add Perform Umrah </button>
            </Link>
          </div>
        </div>
          ...
          <table className="table ">
            ...
            <tbody>
              <tr>
                ...
                <td >
                 <Link href='/b2bdashboard/manage/perform-umrah/update'> 
