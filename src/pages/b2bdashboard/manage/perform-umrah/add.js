...
const PerformUmrah = ( ) => {
  ...
  const handlePerformUmrahData = (e) => {
    e.preventDefault();
    const data = {
      title: title,
      sub_title: subTitle,
        ...
        <div className={styling.profileTop}>
          <div className={styling.flightHistory}>
            <h2 className="text-3xl font-bold text-center">
              Perform Umrah Data Input{" "}
            </h2>
            <div className="w-full mx-auto">
            <form ref={formRef} onSubmit={handlePerformUmrahData}>
...
export default dynamic(() => Promise.resolve(PerformUmrah), { ssr: false });
