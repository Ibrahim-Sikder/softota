          ...
          <table className="table ">
            ...
            <tbody>
              <tr>
                ...
                <td>Inbound Tour Package </td>
                <td>Top package </td>
                <td> Unification of Various Socities</td>
                <td>20-05-23</td>
                <td>
                  <Link href="/b2bdashboard/manage/tour-package/update">
...
export default dynamic(() => Promise.resolve(TourPackage), { ssr: false })
