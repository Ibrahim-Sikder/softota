      ...
      <div className="mt-5 mb-24">
        <div className="flex items-center justify-between px-8 mb-5">
          ...
          <div className={style.addHotel}>
            <Link href='/b2bdashboard/manage/hajj-visa-requirement/add'>
            <button>
              <span className="text-xl font-bold">+</span> Add Hajj Visa Requirement </button>
            </Link>
          </div>
        </div>
          ...
          <table className="table ">
            ...
            <tbody>
              <tr>
                ...
                <td >
                 <Link href='/b2bdashboard/manage/hajj-visa-requirement/update'> 
