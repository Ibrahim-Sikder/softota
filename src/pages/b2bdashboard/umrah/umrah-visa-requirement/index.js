  ...
  return (
    <section>
      <B2BHajjUmrahLayout>
        ...
        <h3 className="text-3xl mb-5 font-bold">Get Umrah Visa 2023 | Online Requirements for Bangladeshi Citizen</h3>
          <div className={style.visaRequirmentImg}>
            ...
            <div className="w-9/12 mt-5 ">
                <h3 className="text-2xl font-bold mb-3 ">All The required documents checklist for Umrah visa processing from Bangladesh</h3>
                <ul >
                    ...
                    <li className="flex items-center">
                    <Beenhere className={style.checkIcon}/>
                        <span>Infants & Children have required blood connected guardian for applying for an Umrah visa  .</span>
                    </li>
                </ul>
            </div>
        </div>
