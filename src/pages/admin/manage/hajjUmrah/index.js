            ...
            <div className={styling.profileTop}>
              <div className={styling.flightHistory}>
               ...
               <form>
                    ...
                    <select  className={styles.inputField}>
                      <option value="Select Hajj Package">Select Hajj Package</option>
                      <option value="Economy Hajj Package">Economy Hajj Package</option>
                      <option value="Shifting Hajj Package">Shifting Hajj Package</option>
                      <option value="Non Shifting Hajj Package">Non Shifting Hajj Package</option>
                 </select>
                      </div>
                      <div>
                    ...
                    <select  className={styles.inputField}>
                      ...
                      <option value="Group People Package">Group People Package</option>
                 </select>
                      </div>
                    </div>
                    <div className={styles.formControl}>
