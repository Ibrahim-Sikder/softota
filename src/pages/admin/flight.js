                                             ...
                                             <table className="table  lg:table-auto columns-xl break-after-column">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            ...
                                                            <td>5143</td>
                                                            <td>156</td>
                                                            <td><span className=' bg-[#26ADE2] rounded text-white py-2 text-xs px-2 font-xs'>View</span></td>
                                                            <td><span className=' bg-red-900 rounded text-white py-2 text-xs px-2 font-xs'>Cancel</span></td>
                                                       </tr>
                                                       <tr>
                                                            <td>Global04</td>
                                                            <td >29 Mar 2023</td>
